...
class CouponChannelRepositoryTest extends TestCase
{
    public function testGetClassName(): void
    {
        // 通过反射验证 Repository 构造函数传递的实体类
        $reflection = new \ReflectionClass(CouponChannelRepository::class);
        ...
        $this->assertStringContainsString('CouponChannel::class', $constructorSource);
    }
}